...
class TestPages(unittest.TestCase):
  ...
  def test_pages_calls_new_pages_when_change_type_new(
    self, mock_edited_pages, mock_new_pages
  ):
  ...
  @patch("wikiedits.client.new_pages")
  @patch("wikiedits.client.edited_pages")
  def test_pages_calls_edited_pages_when_change_type_edited(
    self, mock_edited_pages, mock_new_pages
  ):
  ...
  @patch("wikiedits.client.new_pages")
  @patch("wikiedits.client.edited_pages")
  def test_pages_defaults_to_edited_when_no_change_type(
    self, mock_edited_pages, mock_new_pages
  ):
