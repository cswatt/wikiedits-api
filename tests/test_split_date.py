...
class TestSplitDate(unittest.TestCase):
    ...
    def testsplit_date_yyyymmdd_format(self):
        """Test date already in YYYYMMDD format"""
        result = split_date('20240315')
        self.assertEqual(result, ('2024', '03', '15'))
    
    def testsplit_date_iso_format(self):
        """Test ISO date format conversion"""
        result = split_date('2024-03-15')
        self.assertEqual(result, ('2024', '03', '15'))
    
    def testsplit_date_slash_format(self):
        """Test MM/DD/YYYY format conversion"""
        result = split_date('03/15/2024')
        self.assertEqual(result, ('2024', '03', '15'))
    
    def testsplit_date_dot_format(self):
        """Test DD.MM.YYYY format conversion"""
        result = split_date('15.03.2024')
        self.assertEqual(result, ('2024', '03', '15'))
    
    def testsplit_date_text_format(self):
        """Test text date format conversion"""
        result = split_date('March 15, 2024')
        self.assertEqual(result, ('2024', '03', '15'))
    
    def testsplit_date_single_digit_components(self):
        """Test date with single digit month and day"""
        result = split_date('2024-01-05')
        self.assertEqual(result, ('2024', '01', '05'))
    
    def testsplit_date_december_format(self):
        """Test date in December (month 12)"""
        result = split_date('2024-12-31')
        self.assertEqual(result, ('2024', '12', '31'))
    
    def testsplit_date_with_time_component(self):
        """Test date with time component"""
        result = split_date('2024-03-15T10:30:00')
        self.assertEqual(result, ('2024', '03', '15'))
    
    def testsplit_date_yyyymmdd_edge_cases(self):
    ...
    def testsplit_date_invalid_format(self):
    ...
    def testsplit_date_none_input(self):
    ...
    def testsplit_date_empty_string(self):
    ...
    def testsplit_date_partial_yyyymmdd_invalid(self):
    ...
    def testsplit_date_too_long_numeric_string(self):
        """Test numeric string longer than 8 digits"""
        with self.assertRaises(ValueError) as context:
            split_date('202403151')
