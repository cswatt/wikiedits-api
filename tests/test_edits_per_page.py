...
class TestEditsPerPage(unittest.TestCase):
    ...
    def test_edits_per_page_basic(self, mock_get):
        ...
        result = edits_per_page('en.wikipedia', 'Python', '20240101', '20240102')
        ...
        self.assertEqual(result['items'][0]['edits'], 45)
        self.assertEqual(result['items'][1]['edits'], 52)
    ...
    def test_edits_per_page_with_default_parameters(self, mock_get):
        ...
        edits_per_page('fr.wikipedia', 'Artificial_intelligence', '20240201', '20240228')
    ...
    def test_edits_per_page_date_validation(self, mock_get, mock_validate):
        ...
        edits_per_page('en.wikipedia', 'Test_page', '2024-01-01', '2024-01-02')
