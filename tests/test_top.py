...
class TestTop(unittest.TestCase):
  ...
  def test_top_calls_top_by_edits_when_by_edits(self, mock_abs_diff, mock_net_diff, mock_edits):
    ...
    self.assertEqual(result[0]["page_title"], "Python_(programming_language)")

  @patch("wikiedits.client.top_by_edits")
  @patch("wikiedits.client.top_by_net_diff")
  @patch("wikiedits.client.top_by_abs_diff")
  def test_top_calls_top_by_net_diff_when_by_net_diff(self, mock_abs_diff, mock_net_diff, mock_edits):
  ...
  @patch("wikiedits.client.top_by_net_diff")
  @patch("wikiedits.client.top_by_abs_diff")
  def test_top_calls_top_by_abs_diff_when_by_absolute_diff(self, mock_abs_diff, mock_net_diff, mock_edits):
  ...
  @patch("wikiedits.client.top_by_net_diff")
  @patch("wikiedits.client.top_by_abs_diff")
  def test_top_limits_results_by_count(self, mock_abs_diff, mock_net_diff, mock_edits):
  ...
  @patch("wikiedits.client.top_by_net_diff")
  @patch("wikiedits.client.top_by_abs_diff")
  def test_top_with_custom_parameters(self, mock_abs_diff, mock_net_diff, mock_edits):
  ...
  def test_top_raises_error_for_invalid_by_parameter(self):
    ...
    with self.assertRaises(ValueError) as context:
      top(date="2025-01-01", by="invalid-metric", project="en.wikipedia.org")
    
    self.assertIn("Invalid 'by' parameter: invalid-metric", str(context.exception))
    self.assertIn("Must be 'edits', 'net-diff', or 'absolute-diff'", str(context.exception))
